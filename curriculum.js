 ...
 * - المراجعة: مستوى واحد فقط (BUILDING)
 *   والقائمة مدموج فيها:
 *   - التين + العلق
 *   - القدر + البينة
 */
...
// ======================================================================
// 3. منهج المراجعة: مستوى واحد فقط (BUILDING)
//    مع دمج التين+العلق ، القدر+البينة
// ======================================================================
...
const REVIEW_CURRICULUM = {
  ...
  // لو بالخطأ تم تعيين مستوى آخر للطالب، نخليها نفس القائمة
